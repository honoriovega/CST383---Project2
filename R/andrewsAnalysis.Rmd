...
### Cross Validation
```{r}
rmse_cv = cross_validate_lm(tr_dat, "global_sales", c("user_count","user_score"))
rmse_cv
...
plot(actual ~ predicted, col="DARK RED", pch=20, main="Actual Global Sales by Predicted Global Sales", xlab="Predicted", ylab="Sales")
...
x = tr_dat$user_score
y = tr_dat$user_count
plot(tr_dat$user_score, tr_dat$user_count)
