...
Below is a barplot by games by Genre. We notice that Misc Genre had the most selling games even though it accounts for less games. Based on the barplot, there are far more action games. 
```{r}
par(mar=c(3,7,1,1))
...
In this plot we see critic score tended to curve earlier than user score. The majoriy of games scored by critics has more of even distrubtion while games scored by users has tended to have an higher overall score in games.
